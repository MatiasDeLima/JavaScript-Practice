...
if(mes_atual == 0 || mes_atual == 1 || mes_atual == 2) {
    console.log("As chuvas de meteoros do primeiro trimestre\n"+ meteoros_trimestre_um);
} else if(mes_atual == 3 || mes_atual == 4 || mes_atual == 5) {
    console.log("As chovas de meteoros do segundo trimestre\n" + meteoros_trimestre_dois);
} else if(mes_atual == 6 || mes_atual == 7 || mes_atual == 8) {
    console.log("As chuvas de meteoros do terceiro trimestre\n" + meteoros_trimestre_tres);
} else if(mes_atual == 9 || mes_atual == 10 || mes_atual == 11) {
    console.log("As chvas de meteoros do quarto trimestre"+ meteoros_trimestre_quatro);
} else {
    console.log("Nenhuma chuva de meteoro no periodo informado");
}